...
export default function NotFound({ message = STRINGS.errors.missing }: { message?: readonly [string, string, string, string, string] }) {
  return (
    <div className="mx-auto flex min-h-screen max-w-sm flex-col justify-center gap-6 px-6">
      ...
      <h1 className="font-display text-[19px] leading-relaxed">
        <Pair v={message} />
      </h1>
      <Link href="/" className="text-primary w-fit text-[12px] tracking-[0.25em] lowercase">
